 ...
 * @author tranhoa
 */
public class SpatialStatistic_ implements ij.plugin.PlugIn
{
...
//    private final int RANDOM = 3;
    ...
    public void run(String arg) 
    {
        ...
        byte typeCellSource = BETA;
        int typeDis = 0, typeStatis = 0;
        boolean f = true, g = true;
        String func = "";
        GenericDialogPlus gd = new GenericDialogPlus("Spatial Statistic Analysis");
...
//        " organization applied to \nthe study of the islets of Langerhans");
        ...
        gd.addMessage("Output: F-function result");
        gd.addMessage("Output: G-function result");
        gd.addMessage(" ");
        gd.addMessage(" ");
...
//            objCent.setCalibration(val, val, func);
