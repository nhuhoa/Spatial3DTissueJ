...
//            IJ.log("Idx i: "+i+"  named: "+wList[i]);
        ...
        gd.addMessage(" ");
        gd.addChoice("M1_img ", titles, titles[0]);
        gd.addChoice("M2_img: ", titles, titles[0]);
        gd.addChoice("M3_image: ", titles, titles[0]);
        ...
        if(index[0]!=0 && index[1]!=0 && index[2]!=0 && index[3]!=0)
        {
            ...
            IJ.log(" M1 :"+al.getTitle()+"   M2 :"+be.getTitle()+"   M3 :"+del.getTitle()+"   SLIC label :"+label.getTitle());
        ...
        else if(index[0]!=0 && index[1]!=0 && index[2]==0 && index[3]!=0)
        {
            ...
            WindowManager.setTempCurrentImage(WindowManager.getImage(wList[index[3]-1]));
            dir = IJ.getDirectory("image");
            IJ.log(" M1 :"+al.getTitle()+"   M2 :"+be.getTitle()+"   SLIC label :"+label.getTitle());
            ...
            IJ.error("Need to choose at least 3 input images: (M1, M2, M3, label) or (M1, M2, label) as input");
        }
