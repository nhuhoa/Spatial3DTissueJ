...
public class Rafael_Extract_SLIC_Region_ implements ij.plugin.PlugIn {
...
//                                        }
    ...
    private void correctNucleusSLIC(ImageInt nucLabel, ImageInt label)
    {
        ...
        for (int i = 0; i < popNuclei.getNbObjects(); i++)
        {
            ...
            {
                IJ.log("Percentage of exact segment: " + nb_dapi + " alpha : "+ nbA +" beta: " +nbB + " delta: "+ nbD + 
                        " size: " + list.getSize());
                ac++;
        ...
        nucLabelDraw = new ImageShort("NUC", nucLabel.sizeX, nucLabel.sizeY, nucLabel.sizeZ);
