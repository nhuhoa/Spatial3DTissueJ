 ...
 * @author tranhoa
 */
public class LayerContactAnalysis_V2 implements ij.plugin.PlugIn
{
...
//    private final int RANDOM = 3;
    ...
    public void run(String arg) 
    {
        ...
        int cellId = 0;
        GenericDialog gd = new GenericDialog("Layer Contact Analysis");
...
//        cellId = (int)gd.getNextNumber();
        ...
        File fl = new File(dir+"layer_distance");
        if (!fl.exists()) 
        {
            if (fl.mkdir()) {
                subdir = dir + "layer_distance/";
                IJ.log("Create a layer_distance folder in the directory: "+dir);
            } else {
                subdir = dir;
            }
        }
