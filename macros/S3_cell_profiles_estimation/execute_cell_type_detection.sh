...
##sub_folder="" 
task="cell_profiles_estimation" # Nuc segmentation
...
macro_fn="${macro_dir}S3_cell_profiles_estimation/cell_type_42.txt"



log_file="${macro_dir}S3_cell_profiles_estimation/${task}.log"
echo $log_file
