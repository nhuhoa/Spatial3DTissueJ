...
macro_fn="${macro_dir}S2_markers_processing/SLIC_clustering.txt"
sub_folder="filtered" # a folder where you keep all large tiff files that are extracted from imc_converter
task="marker_processing" # Stack to images
log_file="${macro_dir}S2_markers_processing/${task}.log"
echo $log_file
...
echo $input_dir
#echo "Clustering different channels alpha, beta, delta stainning: \n"
